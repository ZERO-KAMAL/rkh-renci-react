...
const PublicInputShortText: FC<Props> = ({ data, name, onChange, onBlur, value, isError }) => {
  return (
    <div className='w-full mb-5' id={name}>
      ...
      <input
        ...
        type='text'
        placeholder={data.text !== '' ? data.text : 'Short Text'}
        name={name}
        onChange={onChange}
        onBlur={onBlur}
        value={value}
...
export default PublicInputShortText
